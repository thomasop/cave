...
class ControllerB extends Controller
{
    ...
    function show()
    {
        ...
        if ($one) {
            ...
            $twigview = $this->getTwig();
            $twigpostview = $twigview->load('cave_b/cave_b_detail/index.twig');
            echo $twigpostview->render([
            'lists' => $data[0],
            'letters' => $data[1],
            'one' => $one,
    ...
    public function addView()
    {
        ...
        $data = $caveArray->arrayBig($manager);
        $twigview = $this->getTwig();
        $twigpostview = $twigview->load('cave_b/cave_b_add/index.twig');
        echo $twigpostview->render([
            'lists' => $data[0],
            'letters' => $data[1],
            'slug' => $data[3],
    ...
    public function editView()
    {
        ...
        if ($one) {
            $twigview = $this->getTwig();
            $twigpostview = $twigview->load('/cave_b/cave_b_edit/index.twig');
            echo $twigpostview->render([
                'one' => $one,
                'apostrophe' => $_GET['zz']
            ]);
